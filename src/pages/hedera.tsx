...
const [loadingTransaction, setLoadingTransaction] = useState(false);
  ...
  const handleSubmit = async (e) => {
    ...
    if (!info ) {
      ...
      return;
  } else if( totalMinted < 1 ) { 
    setAlertState({
      open: true,
      message: `You don't own any GIGA Peng !`,
      severity: "error",
      hideDuration: null,
    });
  } else {
      ...
      await fetch("https://pengapi.herokuapp.com/api/presale-txns", {
        ...
        .then((response) => {
          if (response.status == 200) {
            ...
            setAlertState({
              open: true,
              message: "Congratulations! Address submited successfully !",
              severity: "success",
            });
          } else {
            setAlertState({
      ...
      <ContainerContent style={{ display: "flex", justifyContent: "center"}}>
        ...
        <CollectionWrapper style={{ margin: "0 auto"}}>
          ...
          <p
           ...
           >
             Congratulation you Minted {totalMinted} GIGA Pengs !
           </p>   
           ...
           >
             Enter your Hedera address bellow
           </p>  
